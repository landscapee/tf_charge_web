<template>
    <div id="project" class="rightBoxContent">
        ...
        <div id="tableBox">
            <div class="tableBox" ref="tableBox">
                <el-table :data="lists" border stripe style="width: 100%" :max-height="maxHeight" :highlight-current-row="true">
                    ...
                    <el-table-column prop="signCode" label="编码"></el-table-column>
                    <el-table-column prop="signName" label="名称"></el-table-column>
                    <el-table-column prop="signItem" label="签名项"></el-table-column>
        ...
        <edit-list ref="ref_editList" :singLists="singLists" @update="update"></edit-list>
    </div>
...
export default {
    ...
    methods: {
        ...
        getLists(data) {
            ...
            this.$axios
                .get('/sign-config/findSignConfigWhitPage', {
                    params: data,
                })
                .then((res) => {
                    console.log(res)
