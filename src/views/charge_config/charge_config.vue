<template>
    <div id="project" class="rightBoxContent">
            ...
            <div class="tableBox" ref="tableBox">
                <el-table :data="lists" border stripe style="width: 100%" :max-height="maxHeight" :highlight-current-row="true">
                    ...
                    <el-table-column prop="unit" label="计量单位">
                        <template slot-scope="scope">
                            {{getName(scope.row.unit,unitLists,'name')}}
                        </template>
                    </el-table-column>
                    <!-- <el-table-column prop="code" label="采集方式"></el-table-column> -->
                    <!-- <el-table-column prop="code" label="创建方式"></el-table-column> -->
                    ...
                    <el-table-column label="发布状态" width="120" align="center">
                        <template slot-scope="scope">
                            <el-button type="text" v-if="scope.row.enable" style="color:#409EFF" @click="publish(scope.row,false)" title="点击取消发布">发布</el-button>
        ...
        <edit-list ref="ref_editList" :unitLists="unitLists" :inputLists="inputLists" @update="update"></edit-list>
    </div>
...
export default {
    ...
    methods: {
        ...
        getLists(data) {
            ...
            this.$axios
                .get('/charge-config/findChargeRecordConfigWhitPage', {
                    params: data,
                })
                .then((res) => {
                    console.log(res)
