    ...
    <div id="project" class="rightBoxContent">
        ...
        <div class="searchBox">
            <div class="leftBox">
                ...
                <div>
                    <el-input class="searchInput" placeholder="请输入内容" v-model="searchStr" clearable @keyup.enter.native="handleLists">
...
export default {
    ...
    methods: {
        ...
        getLists(data) {
            ...
            this.$axios
                .get('/service-config/findServiceConfigWhitPage', {
                    params: data,
                })
                .then((res) => {
                    if (res) {
